...
public class PipeDelimitedRulesTest {
    static final Rules rules = new PipeDelimitedRules();
    ...
    List<String> MALE_RECORD = Arrays.asList(
            ...
            , GENDER_MALE, COLOR_GREEN, PASCAL_BIRTH_DATE
    );

    List<String> FEMALE_RECORD = Arrays.asList(
            FEMALE_LAST_NAME, FEMALE_FIRST_NAME, FEMALE_MIDDLE_INITIAL
            , GENDER_FEMALE, COLOR_RED, FEMALE_BIRTH_DATE
    );

    List<String> BAD_RECORD = Arrays.asList(null, null, null, "male", null, "");
